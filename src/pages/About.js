        ...
        <div className='quranSelector'>
            <Paper sx={{ display: 'flex', flexFlow: 'column', justifyContent: 'space-between', width: { xs: '90%', md: '75%' }, padding: { xs: '2%', md: '2%', lg: '1%' }, opacity: 0.8 }}>
                <div className='about'>
                    ...
                    <p className='aboutText'><b>☁️ Reliable and Seamless Experience</b>: Hosted on the powerful synergy of AWS Lambda and Vercel, I've ensured that your experience on The Blessed Path is seamless and reliable. Embark on this journey without disruptions, embracing the divine at every step.</p>
                    <p className='aboutText'><b>🤖 Powered with AI and LLMs</b>: To enrich the spiritual experience and foster deeper connections, The Blessed Path incorporates an AI Islam Chatbot powered by the OpenAI API and GPT Assistants, offering personalized guidance and support to seekers on their spiritual journey</p>
                    <p className='aboutText'><b>🎨 Aesthetic Brilliance by Me, Faizaan Qureshi</b>: I am Faizaan Qureshi, a software engineer and <b>Computer Science student at the University of Waterloo</b>, weaving a unique blend of technical prowess and artistic sensibility into The Blessed Path's design.</p>
                    <p className='aboutText'><b>📚 Education and Innovation in Harmony</b>: Beyond my role as a software engineer, I'm concurrently attending <b>Wilfrid Laurier University studying Business Administration</b>. The fusion of my technical expertise with a business-oriented education not only propels The Blessed Path but also reflects my commitment to bridging the realms of technology and commerce. This dual pursuit embodies a journey where business acumen and technical innovation harmoniously coexist, shaping a path where education and devotion seamlessly intertwine.</p>
